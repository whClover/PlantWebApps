...
namespace PlantWebApps.Controllers.PER.ExrRepairJobHistory
{
    public class PrintItem : Controller
    {
        ...
        public IActionResult DynamicAfterRepairStandard(string value)
        {
            string query = "SELECT *, CONVERT(varchar, ReceivedDate, 103) AS FormatDate FROM v_ExrRepairTagx WHERE ID IN (" + value + ")";
            Console.WriteLine(query);
            ...
            return View("~/Views/PER/ExrRepairJobHistory/PrintItem/DynamicAfterRepairStandard.cshtml");
        }
        public IActionResult DynamicAfterRepairDirect(string value)
        {
            string query = "SELECT *, CONVERT(varchar, ReceivedDate, 103) AS FormatDate FROM v_ExrRepairTagx WHERE ID IN (" + value + ")";
            Console.WriteLine(query);
            ...
            return View("~/Views/PER/ExrRepairJobHistory/PrintItem/DynamicAfterRepairDirect.cshtml");
        }
