...
namespace PlantWebApps.Controllers.PER.ExrRepairJobHistory
{
    public class ExrRepairJobHistoryInspection : Controller
    {
        ...
        {
            string queryLstPict = $@"Select ID,Picturecaption,PicturePath from tbl_ExrOldCoreInspAttachPic WHERE InspectType='OldCoreInspect' AND WONO={Utility.Evar(tWono, 1)}";
            Console.WriteLine(queryLstPict);
